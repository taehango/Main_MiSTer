...
echo -e "${CYAN}=====================================${NC}"
echo ""
echo -e "${YELLOW}  Korean game name data provided by:${NC}"
echo -e "${YELLOW}  텐타클 팀 (tentacleteam)          ${NC}"
echo -e "${YELLOW}  https://github.com/tentacleteam/romlistkr${NC}"
...
echo -e "${GREEN}=====================================${NC}"
echo ""
echo -e "  Data by 텐타클 팀 (tentacleteam)"
echo -e "  https://github.com/tentacleteam/romlistkr"
echo -e "  MIT License"
echo ""
